...
The Superstore Sales Dashboard is an interactive data analytics project developed in Microsoft Excel to analyze sales, profit, quantity, orders, customers, shipping, and product performance using the Superstore dataset.
